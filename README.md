...
To open the optional Tkinter GUI, run:

```bash
./blizz gui
```

The GUI relies on Tkinter. If you receive an error about missing Tkinter, install `python3-tk` or the Tkinter package for your platform.
